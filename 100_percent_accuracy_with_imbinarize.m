...
nof = 20;
Aw = score(1:4000,1:nof);
Awt = score(4001:5500,1:nof);
Anw = score(5501:9500,1:nof);
Anwt = score(9501:11000,1:nof);
A = [Aw;Anw];
At = [Awt;Anwt];
...
t = [ones(n1,1); -ones(n1,1)];
tt = [ones(n2,1); -ones(n2,1)];
